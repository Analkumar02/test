              ...
              <OrderSummary>
                ...
                <CouponSection>
                  <CouponBox>
                    <CouponInput
                      ...
                      name="promoCode"
                    />
                    <CouponButton onClick={handleCouponApply}>
                      Apply
                    </CouponButton>
                  </CouponBox>
                ...
                {subscriptionUpgraded && (
                  <UpgradeSuccessSection>
                    ...
                    <UndoLink onClick={handleUndoUpgrade}>
                      Undo savings
                    </UndoLink>
                  </UpgradeSuccessSection>
                )}
                ...
                {hasOneTimePurchaseProducts && (
                  <UpgradeSection>
                    ...
                    <UpgradeDescription>
                      Upgrade the following products to a subscription and save
                      up to ${calculateSavings()} today!
                    </UpgradeDescription>
                ...
                <OrderSummaryDetails>
                  ...
                  <SummaryRow>
                    <span>
                      Shipping ({getShippingMethodName(formData.shippingMethod)}
                      )
                    </span>
                    <span>
                      {shipping === 0 ? (
